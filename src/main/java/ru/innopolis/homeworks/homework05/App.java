...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the minimum volume of the television:");
        minVolume = sc.nextInt();

        System.out.println("Enter the maximum volume of the television:");
        maxVolume = sc.nextInt();

        for (Television television : televisions) {
            if (television.isSwitchedon()) {
                if (television.getVolume() >= minVolume && television.getVolume() <= maxVolume) {
